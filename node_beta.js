...
fetch('get_markers.php')
    ...
    .then(data => {
        data.forEach(function (location) {
            ...
            // Create a popup with the location name and delete button
            var popupContent = '<b>' + location.name + '</b><br><button onclick="deleteMarker(' + location.id + ', this)">Delete</button>';
